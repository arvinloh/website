export default function Hero() {
  return (
    // <main className=" bg-light-cyan-500 pt-10 sm:pt-16 lg:overflow-hidden lg:pt-8 lg:pb-0">
        ...
        <div className="mx-auto max-w-7xl lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-8">
            ...
            <div className="relative mt-12 -mb-16 sm:mb-0 lg:flex lg:items-center lg:justify-end">
              <img
              // className="w-3/4 lg:absolute -mt-10 lg:inset-y-0 lg:right-0 lg:h-full lg:w-auto lg:max-w-none hover:scale-105 transition-transform"
                className="w-3/4 mx-auto my-auto flex items-center justify-center lg:absolute -mt-10 lg:inset-y-0 lg:right-0 lg:h-full lg:w-auto lg:max-w-none hover:scale-105 transition-transform"
